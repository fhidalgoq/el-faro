<?php /* Vista genérica de sección — Deporte, Negocios, Tecnología, Cultura */ ?>

<!-- Noticia destacada (RQ-04) -->
<section class="mb-5" aria-labelledby="<?= $seccionId ?>-destacada">
    <h2 class="section-title" id="<?= $seccionId ?>-destacada">Noticia destacada</h2>
    <div class="row g-4">
        <?php if ($destacado): ?>
        <div class="col-lg-7">
            <div class="card card-featured h-100">
                ...
                <div class="card-body p-4">
                    <span class="cat-badge <?= badgeClass($destacado->getSeccion()) ?> d-inline-block mb-2">
...
<!-- Más noticias (RQ-05) -->
<section class="mb-5" aria-labelledby="<?= $seccionId ?>-mas">
    <h2 class="section-title" id="<?= $seccionId ?>-mas">Más noticias de <?= htmlspecialchars($seccionNombre) ?></h2>
    <div class="row g-3">
